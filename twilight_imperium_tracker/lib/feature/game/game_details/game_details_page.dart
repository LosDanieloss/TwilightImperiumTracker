...
class GameDetails extends StatelessWidget {
          ...
          child: Column(
            ...
            children: _buildResultIcon(context: context, result: game.result, translations: translations)
              ..addAll([
                ...
                _buildCollectedPoints(translations: translations, collectedPoints: game.points, goal: game.goal),
  ...
  List<Widget> _buildResultIcon(
      {@required BuildContext context, @required GameResult result, @required Translations translations}) {
    return [
      Icon(
  ...
  Widget _buildRacesInPlayHeader({@required BuildContext context, @required Translations translations}) {
    return Padding(
      ...
      child: Text(translations.text('race_used_game'),
          style: Theme.of(context).textTheme.subhead.merge(TextStyle(fontSize: 20))),
    );
  }
